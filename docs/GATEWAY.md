...
2. [INDEX.md](INDEX.md)
3. [04-status/project_management_and_logs/last_log.md](04-status/project_management_and_logs/last_log.md)
...
5. [04-status/project_management_and_logs/TASK_LIST.md](04-status/project_management_and_logs/TASK_LIST.md)
6. [04-status/project_management_and_logs/DECISION_LOG.md](04-status/project_management_and_logs/DECISION_LOG.md)
...
- Jika user bilang `lanjut`, baca `last_log.md` lalu `TASK_LIST.md`.
- Jika user minta peta dokumentasi, baca `INDEX.md`.
- Jika user minta status yang paling dapat dipercaya, baca `last_log.md`,
  `RELEASE_NOTES.md`, lalu `BEST_PRACTICE_FIX_PLAN.md`.
